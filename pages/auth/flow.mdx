...
https://api.sodex.cloud/oauth/authorize?client_id=your_client_id&redirect_uri=https://your-app.com/callback&response_type=code&scope=sdxapi%20...&state=random_state_string&code_challenge=your_code_challenge&code_challenge_method=S256
```
...
authUrl.searchParams.set('scope', 'sdxapi ...');
